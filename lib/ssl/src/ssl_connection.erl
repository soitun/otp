...
cipher(#finished{}, #state{role = server, expecting_next_protocol_negotiation = true, next_protocol = undefined, negotiated_version = Version} = State0) ->
...
do_server_hello(Type, NextProtocolsToSend, #state{negotiated_version = Version,
    ...
    State1 = server_hello(ServerHello, State0#state{expecting_next_protocol_negotiation = NextProtocolsToSend =/= undefined}),
